  ...
  helped build the infrastructure behind Sanjeevani Pariyojana, a COVID-era healthcare platform running on EKS at 99.99% SLO.                                                       
                                                                  
  ### What I work with                                                                                                                                                              
   
  `Kubernetes` · `Docker` · `Terraform` · `Melange` · `apko` · `Wolfi` · `Cosign` · `Sigstore` · `Notary` · `GitHub Actions` · `ArgoCD` · `Jenkins` · `HashiCorp Vault` · `AWS` ·   
  `GCP` · `Azure` · `Node.js` · `NestJS`                          
